...
public interface ContractService {
     ...
     */
    void signContractAndGeneratePdf(Long contractId, String ipAddress, Long currentUserId);

    Page<ContractResponse> getMyContracts(Long userId, String keyword, ContractStatus status, Pageable pageable);

    Page<AdminContractResponse> getContractsForAdmin(String keyword, ContractStatus status, Boolean isFeePaid,
            Pageable pageable);
