...
public class ClassRequestApprovedEmailSender extends BaseEmailSender<StudentTutorPayload> {
    public ClassRequestApprovedEmailSender(JavaMailSender mailSender, TemplateEngine templateEngine) { super(mailSender, templateEngine); }
